...
;(function(window) {
  ...
  function runInContext(context) {
    ...
    /** Used to lookup a built-in constructor by [[Classes]] */
    var ctorByClass = {};
    ...
    (function() {
      ...
      /**
       * Detect if an `arguments` object's [[Classes]] is resolvable (all but Firefox < 4, IE < 9).
       *
       * @memberOf _.support
       * @type Boolean
       */
      ...
      /**
       * Detect if a DOM node's [[Classes]] is resolvable (all but IE < 9)
    ...
    // fallback for browsers that can't detect `arguments` objects by [[Classes]]
    ...
    function isNaN(value) {
      ...
      // (perform the [[Classes]] check first to avoid errors with some host objects in IE)
